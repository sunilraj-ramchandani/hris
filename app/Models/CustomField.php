    ...
    public static function getFields($table,$company){
        ...
        foreach($fields as $field){
            ...
            if($field->field_type == "area"){
                $html_code = [$company_id,"<label>".$field->field_name."</label>","<textarea class='mt-2 form-control' name='".$field->field_name."'>".$field->custom_value."</textarea>"];
            }if($field->field_type == "email"){
                $html_code = [$company_id,"<label>".$field->field_name."</label>","<input value='".$field->custom_value."' type = 'email' class='mt-2 form-control' name='".$field->field_name."'>"];
            }if($field->field_type == "text"){
                $html_code = [$company_id,"<label>".$field->field_name."</label>","<input value='".$field->custom_value."' type = 'text' class='mt-2 form-control' name='".$field->field_name."'>"];     
            }
