...
@section('content')
@include('modals.employee_increase_modals')
...
<script>
  $(document).ready(function() {
    ...
    $(".edit_button").click(function() {
        ...
        $('#employee_number').prop('readonly',true);
        ...
        $('#cost_centers_id').prop('disabled',true);
    });
} );
</script>
@endsection