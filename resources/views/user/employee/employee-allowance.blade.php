...
@section('content')
@include('modals.employee_allowance_modals')
...
<div class="container-fluid pt-4 mt-4">
    ...
    <table class="table table-bordered" id="employee-allowance-table">
        <thead>
            <tr>
    ...
    <div class = "row pt-4 mt-4">
        <div class = "col-12 text-right">
            <button type="button" class = "btn btn-info" data-bs-toggle="modal" data-bs-target="#employees_allowance" style="color:white">Add Allowance to Employees</button>
            <button type="button" class = "btn btn-warning add_custom_field" data-bs-toggle="modal"  data-table="employees_allowance" data-bs-target="#custom_field">Add Custom Field</button>
        </div>
    </div>
...
<script>
  $(document).ready(function() {
    var table = $('#employee-allowance-table').DataTable( {
        lengthChange: true,
